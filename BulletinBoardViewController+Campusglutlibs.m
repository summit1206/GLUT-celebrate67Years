#import "BulletinBoardViewController+Campusglutlibs.h"
@implementation BulletinBoardViewController (Campusglutlibs)
- (void)talkFrameArrayCampusglutlibs:(NSString *)campusglutlibs {
    NSLog(@"%@", campusglutlibs);
}
...
- (void)checkCertificationCampusglutlibs:(NSString *)campusglutlibs {
    NSLog(@"%@", campusglutlibs);
}
- (void)checkCertificationWiht:(NSString *)name password:(NSString *)psword campusglutlibs:(NSString *)campusglutlibs {
    NSLog(@"%@", campusglutlibs);
}
- (void)sendTextViewControllerCampusglutlibs:(NSString *)campusglutlibs {
    NSLog(@"%@", campusglutlibs);
}
