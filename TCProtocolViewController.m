...
- (void)viewDidLoad {
    ...
    aboutGlut.text = @"1、重要须知： 本公司在此特别提醒，用户（您）欲访问和使用桂工教务在线， 必须事先认真阅读本服务条款中各条款， 包括免除或者限制程本公司责任的免责条款及对用户的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或随时对其的修改， 您应不使用或主动取消本应用提供的服务。您的使用行为将被视为您对本服务条款全部的完全接受， 包括接受本公司对服务条款随时所做的任何修改。\n\n2、这些条款可由本公司随时更新， 且毋须另行通知。桂工教务在线服务条款(以下简称“服务条款”)一旦发生变更， 本公司将在简书网上公布修改内容（https://www.jianshu.com/p/4382219ca316）。修改后的服务一旦在网页上公布即有效代替原来的服务条款。您可随时登陆简书查阅最新版服务条款。\n\n3、感谢你使用本应用，谢谢你的信任，本应用只会在本应用内部使用用户的数据信息，绝对不会盗用用户的信息。\n\n4、最后，本公司想要彻底澄清一点：我们从未与任何国家的任何政府机构就任何产品或服务建立过所谓的 \"后门\"。我们也从未开放过我们的服务器，并且永远不会。\n\n5、我们对保护个人隐私的承诺，源于对用户深深的尊重。我们知道，获得你的信任并非易事。也正因如此，我们才一如既往地全力以赴，来赢得并保持这份信任。\n\n\n ";
